  ...
  <Link href="/#home" className="flex items-center gap-6">
      ...
      Trackify Finance
                    ...
                    <div className="hidden lg:flex items-center">
                        {/* Static version of the user-related content */}
                        <div className="flex items-center gap-x-4">
                            <Link href="https://app.mytrackify.com/sign-in" className={buttonVariants({ size: "sm", variant: "ghost" })}>
                                Sign In
                            </Link>
                            <Link href="https://app.mytrackify.com/sign-up" className={buttonVariants({ size: "sm", })}>
                                Get Started
