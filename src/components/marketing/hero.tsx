...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Simplifying finance management with AI"}
            ...
            <Container delay={0.1}>
                ...
                Take control of your finances with powerful tracking, insightful analytics, and automated reporting. <span className="hidden sm:inline">Trackify helps you make smarter financial decisions.</span>
                </p>
            </Container>
            <Container delay={0.2}>
            ...
            <Container delay={0.3}>
                ...
                <div className="absolute top-1/4 left-1/2 -z-10 w-3/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[10rem] bg-gradient-to-r from-green-200 via-green-300 to-green-400"></div>
